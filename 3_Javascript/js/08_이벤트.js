...
test2.addEventListener( "click", function() {
  ...
  if(test2.style.opacity == 0) { // 완전히 투명해졌다면 다시 불투명하게 바꿔라
    test2.style.opacity = 1;
  }
...
box3.addEventListener("click", function() {
  ...
  // e.target : 이벤트가 발생한 요소 == this
    
  alert(`현재 배경색: ${box3.style.backgroundColor}`);
});
