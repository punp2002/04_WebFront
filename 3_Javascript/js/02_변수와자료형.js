...
console.log(1234);
console.log("문자열은 양쪽에 쌍따옴표 작성(홑따옴표도 가능)");
console.log('JS는 홑따옴표도 문자열 취급');
...
// 의미함.
// 즉, 코드 블록 내ㅜ부에서 선언한 변수(let, const)는
...
// 함수안에서는 어떻게 될까?
function example() { // 이렇게 함수형태로 만들어진
...
// typefo 연산자 : 변수/값의 자료형을 출력하는 연산자.
